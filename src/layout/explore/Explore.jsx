      ...
      <div className='explore'>
        <div className="navbar">
          <div className="nav">
            ...
            <svg viewBox="0 0 24 24" aria-hidden="true" className="r-4qtqp9 r-yyyyoo r-z80fyv r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-19wmn03" style={{ color: "rgb(239, 243, 244)",width:"40px",height: "40px" }}>
          ...
          return (
            <div className="trend-item">
              <div>
                ...
                <p className="main-trend">{data.mainTrend}</p>
                <p className="tweet-count">{data.Twtcount}</p>
              </div>
